...
def main():
   ...
   # Add rounded image
    image_path = Image.open("C:\\Users\\vvsan\\Downloads\\srixlogo1.png")
    ...
    if menu == "Homepage":
        ...
        with col1:
            image = Image.open('C:\\Users\\vvsan\\Downloads\\inventory_1.jpg')
    ...
    if menu == "Formulation":
        ...
        with col4:
            image = Image.open('C:\\Users\\vvsan\\Downloads\\transport.jpeg')
            st.image(image, use_column_width=True)
        with col3:
